...
(function(e, t) {
	...
	G || (z = b.valHooks.button = {
		...
		function(e, t, n, r) {
			...
			var s = "stellar",
				...
				l = f("transform"),
				c = e("<div />").css("background-position-x") !== r,
				h = c ? function(e, t, n) {
					e.css({
		...
		! function(e, t, n) {
			...
			function v(e) {
				if (!this.spin) return new v(e);
				this.opts = h(e || {}, v.defaults, d)
			}
		...
		function() {
			jQuery(function() {
				...
				return $("#alerts").on("click", ".destroy", function(e) {
					var t;
					return e.preventDefault(), $(".alert").removeClass("show"), t = function() {
					...
					return $("#apply span").html((new Spinner(u)).spin().el)
				}), f = navigator.userAgent, i = /WebKit/.test(f) && /Mobile/.test(f), i ? $("body").addClass("mobile") : $(window).stellar({
					horizontalScrolling: !1,
					parallaxElements: !1
				}), s = $(".navigation").find("li"), a = $(".slide"), o = $(window), r = $("html,body"), $("header").css("position") === "fixed" ? n = $("header").outerHeight() : n = 0, e = function(e, t) {
					var n, r;
					return r = $(this).attr("data-slide"), n = $(".navigation li[data-slide='" + r + "']"), t === "down" ? n.addClass("active").prev().removeClass("active") : n.addClass("active").next().removeClass("active")
				}, a.waypoint(e, {
					offset: n
				}), o.scroll(function() {
					if (o.scrollTop() === 0) return $('.navigation li[data-slide="1"]').addClass("active"), $('.navigation li[data-slide="2"]').removeClass("active")
				}), t = function(e) {
					var t, i, s;
					return t = $(".navigation li.active").data("slide"), i = e > t ? n - 1 : n + 1, s = {
						scrollTop: $(".slide[data-slide='" + e + "']").position().top - i
					}, r.animate(s, 1e3, "easeInOutQuint")
				}, s.click(function(e) {
					var n;
					return e.preventDefault(), n = $(this).attr("data-slide"), t(n)
				})
			})
		}.call(this);, vt = / jQuery\d+="(?:null|\d+)"/g, mt = new RegExp("<(?:" + dt + ")[\\s/>]", "i"), gt = /^\s+/, yt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, bt = /<([\w:]+)/, wt = /<tbody/i, Et = /<|&#?\w+;/, St = /<(?:script|style|link)/i, xt = /^(?:checkbox|radio)$/i, Tt = /checked\s*(?:[^=]|=\s*.checked.)/i, Nt = /^$|\/(?:java|ecma)script/i, Ct = /^true\/(.*)/, kt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Lt = {
		...
		Lt.optgroup = Lt.option, Lt.tbody = Lt.tfoot = Lt.colgroup = Lt.caption = Lt.thead, Lt.th = Lt.td, b.fn.extend({
			...
			buildFragment: function(e, t, n, r) {
				...
				for (; d < c; d++) {
					...
					if (!Et.test(s)) p.push(t.createTextNode(s));
					else {
	...
	function(e, t) {
		...
		}), e(document).delegate n === "coords" ? r.value !== "" : r.specified) ? r.value : t
	}, set: function(e, n, r) {
